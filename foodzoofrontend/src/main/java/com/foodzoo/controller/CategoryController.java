...
public class CategoryController {
	...
	/**
	 * callcategory method is used to show the category list on
	 * managecategory.jsp file and It will be called on the action
	 * manageCategory.On successful completion of this method a list of existing
	 * categories will be shown on managecategory.jsp file. for viewing the
	 * category list it will call the respective viewCategoryService method
	 * which is linked to viewCategoryDAO method of CategoryDAO class.That
	...
	/**
	 * saveCategory method is used to save the Category object obtained from
	 * managecategory.jsp file and It will be called on the action
	 * savecategory.On successful completion of this method Category data will
	 * be saved into database In this method saveCategoryService method of class
	 * CategoryServiceDAO will be called which will further call save method of
	 * CategoryDAO class.
	 * 
	 * @param newcategory
	 *            is an object of class Category.This Object is binded with data
	 *            sent by the form.
	 * @param result
	 ...
	 * particular id category and this category will be deleted by calling
	 * method deleteCategoryService of CategoryServiceDAO. which will call
	 * deleteCategory method of CategoryDAO class.
	 * 
	 * @param id
	...
	/**
	 * categoryupdate method is used to update the category object obtained from
	 * managecategory.jsp file and It will be called on the action
	 * categoryupdate.On successful completion of this method Category data will
	 * be updated into database In this method updateCategoryService method of
	 * class CategoryServiceDAO will be called which will further call update
