...
function drawChart() {
  ...
  var options1 = {'title':'Categories Names', 'width':550, 'height':400};
  var options2 = {'title':'Categories Users', 'width':550, 'height':400};
...
<td ><a href="#categoryedit" class="" ><i class="fa fa-pencil" aria-hidden="true"  ></i></a>
</td>
<td><a href="categorydelete/${x.category_id}"><i class="fa fa-trash-o" aria-hidden="true" id=""></i></a>
</td>
</tr>
</c:forEach>
</table>
...
<form:input id="three" path="category_description" class="form-control"></form:input>
</div>
...
<div class="col-sm-4">
<center>
<input type="submit" class="btn btn-success" value="save" id="category_button" style="margin-top:10px;margin-bottom:10px;"></input>
</center>
